...
define("ADLAN_187", "Nem lehet létrehozni: [b][x][/b]. Kérjük, ellenőrizze a mappa jogosultságait.");
...
define("ADLAN_189", "A következő plugin(ok) nem kompatibilis(ek) az e107 ezen verziójával és ezért el kell távolítani: [x] [y]");
...
define("LAN_PASSWORD_WARNING", "NAGYON ajánlott, hogy [változtasd meg a jelszó kódolást] a PHP alapértelmezettre.<br>(A jelszóbevitelek automatikusan frissülnek a felhasználói bejelentkezés során.)");
...
define("LAN_UI_FORM_METHOD_ERROR", "VÉGZETES HIBA: a [x] mezőnév nem engedélyezett! A [x] kulcsot nevezd át valami másra a tömbben és az adatbázis táblában (ha szükséges).");
