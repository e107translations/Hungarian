...
define ("EPL_ADLAN_9", "Sikertelen SQL parancsok! Ellenőrizd, hogy minden frissítési változtatás rendben volt-e.");
define ("EPL_ADLAN_10", "Név");
define ("EPL_ADLAN_11", "Verzió");
define ("EPL_ADLAN_13", "Kompatibilis");
define ("EPL_ADLAN_14", "Ismertetés");
define ("EPL_ADLAN_15", "A bővebb információkért olvasd el a README fájlt");
...
define ("EPL_ADLAN_31", "A teljes eltávolításhoz töröld az ");
define ("EPL_ADLAN_32", "könyvtárat és az összes benne lévő fájlt.");
...
define ("EPL_ADLAN_36", "Sikertelen értelmező kód beillesztés! Hibás formázás.");
define ("EPL_ADLAN_37", "Bővítmény feltöltése (.zip formátum)");
define ("EPL_ADLAN_38", "Bővítmény feltöltése");
define ("EPL_ADLAN_39", "A fájl nem tölthető fel, mert a(z) ".e_PLUGIN." könyvtár nem írható - adj rá írási jogot (CHMOD 777) és töltsd fel újra.");
define ("EPL_ADLAN_40", "Admin üzenet");
define ("EPL_ADLAN_41", "A fájl nem tűnik ténylegesen .zip vagy .tar archívumnak.");
...
define ("EPL_NOINSTALL", "Nincs szükség telepítésre, csak aktiváld a menükezelő területről. Az eltávolításhoz töröld a ");
...
define ('EPL_ADLAN_103', "Hozz létre egy új írható könyvtárat az [x] könyvtárban Pl.: [b]myplugin[/b]");
...
define ('EPL_ADLAN_217', "[x] a legenerált admin terület megtekintéséhez.");
define ('EPL_ADLAN_218', "Ide nem lehet írni: [x]");
