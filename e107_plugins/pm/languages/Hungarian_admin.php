...
define("ADLAN_PM_68", "[x] blokkolás lett eltávolítva a törölt felhasználóknál");
define("ADLAN_PM_69", "[x] blokkolás lett eltávolítva a törölt felhasználóktól");
define("ADLAN_PM_70", "Adatbázis hiba: [y]: [z] blokkolt felhasználók eltávolítása közben");
define("ADLAN_PM_71", "Időtúllépési üzenetek");
define("ADLAN_PM_72", "Nincs PM időtúllépés beállítva");
define("ADLAN_PM_73", "[x] időtúllépéses PM lett törölve");
define("ADLAN_PM_74", "[x] üzenet lett törölve, melyeket törölt felhasználók küldtek");
define("ADLAN_PM_75", "[x] üzenet lett törölve, melyeket törölt felhasználóknak küldtek");
define("ADLAN_PM_77", "(Ürítsd ki a mezőket és frissítsd a limitek törlését)");
define("ADLAN_PM_78", "Mellékletek ellenőrzése");
define("ADLAN_PM_79", "[x] elárvult melléklet lett törölve. [y] hiányzó melléklet lett feljegyezve");
